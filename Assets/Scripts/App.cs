    ...
    class TimerPageState : State<TimerPage>
    {
        ...
        public override void initState()
        {
            ...
            mTimer = Window.instance.periodic(DELAY, () =>
            {
                ...
                UnityEngine.Debug.LogFormat("DELAYED:{0}", mStopwatch.Elapsed.TotalSeconds);

                mTimeText = string.Format("{0}:{1}", 24 - mStopwatch.Elapsed.Minutes, 59 - mStopwatch.Elapsed.Seconds);
            ...
            return
                new Stack(
                    children: new List<Widget>()
                    {
                        ...
                        child: new Text(data: mTimeText, style: new TextStyle(
                                    color: Colors.black,
                                    fontSize: 54,
